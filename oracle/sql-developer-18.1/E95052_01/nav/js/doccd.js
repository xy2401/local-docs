...
function readBreadcrumbs() {
  ...
  var breadc = {
"home":"http://docs.oracle.com",
"category":"Database",
"categoryurl":"http://docs.oracle.com/en/database/",
"product":"SQL Developer Documentation Release 18.1",
"producturl":"index.html"
  ...
  /*  function getHttpObject() {
    ...
    parseResponse_breadcrumbs(breadc);
  } else {
...
function parseResponse_breadcrumbs(breadc) {
...
function leftNav() {
  ...
  exportAs.appendChild(document.createTextNode("Other Formats"));
...
function addThisDocument() {
  ...
  // cloud part
    ...
    function showTopics() {
      ...
      function parseResponse_json(jsonData) {

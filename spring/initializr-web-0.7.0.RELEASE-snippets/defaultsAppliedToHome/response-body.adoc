                ...
                <div class="form-group project-choice">
                    <h2>
                        ...
                        <select tabindex="3" class="form-control" name="bootVersion" id="bootVersion">
                            <option value="2.2.0.BUILD-SNAPSHOT" >Latest SNAPSHOT</option>
                            <option value="2.1.4.RELEASE"  selected>2.1.4</option>
                            <option value="1.5.17.RELEASE" >1.5.17</option>
                        </select>
                    </span>
                    </h2>
                </div>
            ...
            <div class="row">
                <div id="dependencies" class="full hidden">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="checkbox" data-range="2.2.0.BUILD-SNAPSHOT">
                            <label>
                                <input tabindex="13" type="checkbox" name="style" value="org.acme:biz">Biz
                                <p class="help-block"></p>
                                <p class="help-block version-requirement">requires Spring Boot &gt;&#x3D;2.2.0.BUILD-SNAPSHOT</p>
                            </label>
                        </div>
                        <div class="checkbox" data-range="[2.1.4.RELEASE,2.2.0.BUILD-SNAPSHOT)">
                            <label>
                                <input tabindex="13" type="checkbox" name="style" value="org.acme:bur">Bur
                                <p class="help-block"></p>
                                <p class="help-block version-requirement">requires Spring Boot &gt;&#x3D;2.1.4.RELEASE and &lt;2.2.0.BUILD-SNAPSHOT</p>
                            </label>
                        </div>
                        <div class="checkbox" data-range="">
                            <label>

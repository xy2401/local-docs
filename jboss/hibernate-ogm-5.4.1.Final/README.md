...
and the target directory for the extracted binary (defaults to _/mnt/jenkins-workdir/workspace/hibernate-ogm-release/distribution/target/embeddedMongoDb/extracted_) like this:
